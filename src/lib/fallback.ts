...
function getFallbackDeadlines() {
  ...
  return [
    ...
    },
    {
      ...
      action: "Ensure Safer Food Better Business records are up to date.",
    ...
    },
    {
      ...
      category: 'food_safety' as const,
      dueDate: null,
      description: 'Full allergen labelling on all PPDS food. 14 major allergens declared.',
      penalty: 'Unlimited fine and/or up to 2 years imprisonment',
      action: 'Review and update allergen labels and written allergen info for non-prepacked food.',
      severity: 'warning' as const,
    },
    {
      id: 'dl-haccp',
      ...
      category: 'food_safety' as const,
      dueDate: null,
      description: 'Maintain documented HACCP-based food safety management system.',
      penalty: 'Improvement notice, prohibition order, or prosecution',
      action: 'Review HACCP documentation and ensure all records are current.',
      severity: 'warning' as const,
    },
    {
      id: 'dl-personal-licence',
      title: 'Personal Licence Holder Training Refresher',
      category: 'scottish' as const,
      dueDate: null,
      description: 'Scottish Certificate for Personal Licence Holders — refresher every 5 years.',
      penalty: 'Loss of personal licence',
      action: 'Check refresher training date and book if due within 12 months.',
      severity: 'warning' as const,
    },
    {
      id: 'dl-outdoor-seating',
      title: 'Outdoor Seating Licence Renewal',
      category: 'council' as const,
      dueDate: null,
      description: 'Annual licence for tables/chairs on public pavement.',
      penalty: 'Removal of furniture, fine',
      action: 'Apply to City of Edinburgh Council for renewal.',
      severity: 'warning' as const,
    },
    {
      id: 'dl-pension',
      title: 'Auto-Enrolment Pensions — Ongoing',
      category: 'employment' as const,
      dueDate: null,
      description: 'Enrol eligible workers. Min contribution: 3% employer, 5% employee. Re-enrolment every 3 years.',
      penalty: 'TPR enforcement: £50–£10,000/day',
      action: 'Ensure all eligible staff are enrolled and contributions are up to date.',
      severity: 'warning' as const,
    },
    {
      id: 'dl-eli',
      title: "Employer's Liability Insurance — Active",
      category: 'employment' as const,
      dueDate: null,
      description: 'Must hold minimum £5M cover. Display certificate at premises.',
      penalty: '£2,500 per day without valid insurance',
      action: 'Verify ELI certificate is current and displayed at premises.',
      severity: 'warning' as const,
    },
  ];
}
